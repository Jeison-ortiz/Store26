...
<?php
    ...
    if (!$resultado){
        ...
        echo 'A ocurrido un error, por favor intenta mas tarde!';
        die();  
    }

    
    header('location:subirArticulos.php');
					...
					<img src="../imagenes/logo/Logo.png" id = "logoRestringido">
						...
						<div class = "d-flex" id= "ome">					
							<form action="" class = "aling-items-center"></form>
								<button class="btn btn-secondary me-2"  data-target="#d1">Cerrar sesión</button>
							</form>
						</div>					
                    ...
                    <div class ="container">
                        ...
                        <div >
                            ...
                            <div id = "cardPrecio">
                                ...
                                <a href="agregarArticulos.php?id=<?php echo $dato['id'];?>&tabla=<?php echo $tablaDatos;?>"><img src="../imagenes/logo/papelera.png" id="papelera"></a>
                            </div>
                        </div>
                    </div>
