...
$sentencia_eliminar = $pdo->prepare($sql_unico);
...
<body>
  ...
  <div class = "container">
    ...
    <div class = "container" id = "formulario">
      <form method = "POST" enctype = "multipart/form-data" name = "formLoadArticule" class = "container" id = "formulario1">
        ...
        echo '<div class = "container mt-3"';
            ...
            foreach($resultado as $dato):?>  
                ...
                <div class="card container card-body col-sm" id = "containerCard">
                    ...
                    <a href="actualizarArticulos.php?id=<?php echo $dato['id'];?>&tabla=<?php echo $tablaDatos;?>">eliminar</a>
                
                </div>
            <?php endforeach ?>     
        </div>
    <?php endif ?>
    <?php header('Location: subirArticulos.php');
    ?>
